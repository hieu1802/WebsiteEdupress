...
import { AiFillRocket, AiOutlineUserAdd, AiOutlineClockCircle, AiFillCheckCircle, AiOutlineDoubleLeft , AiOutlineDoubleRight     } from "react-icons/ai";
       ...
       <div className='articles'>
          <div className='articlesHeading'>
             <div className='articlesTitle'>
                ...
                <p>Khám phá các hành động miễn phí của chúng tôi</p>
             </div>
             <div className='btnCategories'> <p>Xem tất cả</p></div>
          </div>
       </div>       
