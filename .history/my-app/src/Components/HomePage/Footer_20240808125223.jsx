    ...
    <div className='footerPage'>
        <div className='footerContaier'>
            ...
            <div className='footerPrograms'>
                ...
                <a href='#'><AiOutlineUserAdd style={{color:'FF782D', marginRight:'10px'}}/> Business</a>
                <a href='#'><AiOutlineUserAdd style={{color:'FF782D', marginRight:'10px'}}/> IT & Software </a>
                <a href='#'><AiOutlineUserAdd style={{color:'FF782D', marginRight:'10px'}}/> Languages </a>
                <a href='#'><AiOutlineUserAdd style={{color:'FF782D', marginRight:'10px'}}/> Programming </a>
            </div>
