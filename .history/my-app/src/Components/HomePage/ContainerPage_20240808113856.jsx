...
import { AiFillRocket, AiOutlineUserAdd, AiOutlineClockCircle, AiFillCheckCircle, AiOutlineDoubleLeft , AiOutlineDoubleRight ,AiFillStar     } from "react-icons/ai";
    ...
    <div className='ContainerPage'>
       ...
       <div className='boxFeedbacks'>
          <div className='feedbacksHeading'>
              ...
              <p>Lắng nghe đánh giá của học viên sau khi theo học ở EduPress Academy nhé !!!</p>
          </div>
              ...
              <div className='feedbackItems'>
                  <div className='feedbacksContents'>
                      ...
                      <div className='feedbacksContentText'>
                          <p>I must explain to you how all this mistaken . Tdea of denouncing pleasure and praising 
                          pain was born and I will give you a complete account of the system and expoun</p>
                      </div>
          ...
          <div className='articlesContainer'>
            <div className='articlesBox'>
              ...
              <div className='articlesContent'>
                 ...
                 <span> <AiFillStar style={{color:'ovar(--Primary, #FF782D)'}}/>  Jan 24, 22023</span>
